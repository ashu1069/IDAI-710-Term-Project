...
original_dir = '/home/stu12/s11/ak1825/idai710/Project/original_images' #C:/Diana/America docs/courses Spring 24/Fund of ML/final project/project/original_images
...
try:
    model = torch.load('/home/stu12/s11/ak1825/idai710/Project/Dehazed-Detection/Dehaze-Net/dehazenet.pt').to(device)
    model.eval()
