...
class DehazingDataset(Dataset):
    def __init__(self, original_dir, foggy_dir, bb_dir, subset='train', transform=None):
        """
        Args:
        ...
        """
        self.original_dir = os.path.join(original_dir, subset)
    ...
    def __getitem__(self, idx):
        ...
        original_image_path = os.path.join(self.original_dir, img_name)
