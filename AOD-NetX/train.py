...
def collate_fn(batch):
    ...
    batch_mod['original_image'] = default_collate(batch_mod['original_image'])
...
def main():
    ...
    train_dataset = DehazingDataset(original_dir, foggy_dir, bb_dir, 'train', transform=transform)
    val_dataset = DehazingDataset(original_dir, foggy_dir, bb_dir, 'val', transform=transform)
    ...
    torch.save(model, '/home/stu12/s11/ak1825/idai710/Project/Dehazed-Detection/AOD-NetX/aodnetX2.pt')
